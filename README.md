...
- **Filtri per canale** — di un canale che pubblica più rubriche/podcast puoi tenere solo ciò che ti interessa: regole "mostra solo…" o "nascondi…" per parole nel titolo (più l'opzione "niente shorts"), applicate **automaticamente anche ai video futuri**, con anteprima in tempo reale, scheda "Nascosti dal filtro" per controllare cosa viene escluso e sincronizzazione nel cloud.
